        ...
        <div className="settings__info">
          ...
          <form className='settings__form' action="" method="post">
            ...
            <div className='settings__column'>
              <button type="submit" className="settings__btn">Изменить пароль</button>
              <button type="submit" className="settings__btn settings__btn-exit">Выйти из аккаунта</button>
